...
static const char *test_dir(void) { return "/tmp/dlproxy_cache_test"; }
...
TEST_F(CacheTest, InvalidArgs) {
  ...
  ASSERT_EQ(dlp_cache_write(nullptr,"r","0",0,(uint8_t*)"x",1,nullptr,nullptr), xErrno_InvalidArg);
  ASSERT_EQ(dlp_cache_write(cache,nullptr,"0",0,(uint8_t*)"x",1,nullptr,nullptr), xErrno_InvalidArg);
...
TEST_F(CacheTest, AutoGrowBlocks) {
  ...
  uint8_t data[1024]; memset(data,0xEE,1024);
  comp_ctx c = {};
